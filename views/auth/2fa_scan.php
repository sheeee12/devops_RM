            ...
            <div class="login-content text-center" style="color: #020b08ff;">
                ...
                <?php if ($isNew): ?>
                    ...
                    <div class="alert alert-light  shadow-sm text-start small mb-4 p-3 ">
                        ...
                        <span
                            data-i18n="2fa.instruct_1"><?php echo str_replace('Google Authenticator', '<strong style="color: #059669;">Google Authenticator</strong>', Lang::get('2fa.instruct_1')); ?></span><br>
                ...
                <?php else: ?>
                    <!-- CAS 2 : VERIFICATION -->
                    <h1 class="login-title h3" data-i18n="2fa.verify_title"><?php echo Lang::get('2fa.verify_title'); ?>
                    </h1>
                ...
                <?php if (isset($_GET['error'])): ?>
                    <div class="alert alert-danger border-0 bg-danger-subtle text-danger py-2 mb-3 small"
                        data-i18n="2fa.error_invalid_code">
                ...
                <form action="../../actions/login_action.php" method="POST">
                    ...
                    <div class="form-floating mb-4" id="btn">
                        ...
                        <label for="code2fa" class="text-center w-100" id="labelCode"
                            data-i18n="2fa.label_code"><?php echo Lang::get('2fa.label_code'); ?></label>
                    </div>
                ...
                <div class="mt-4 border-top pt-3">
                    <p class="text-muted small mb-2" data-i18n="2fa.lost_app_text">
                        <?php echo Lang::get('2fa.lost_app_text'); ?></p>
                    <form action="../../actions/reset_2fa_ask.php" method="POST">
                        <button type="submit" class="btn btn-link text-decoration-none p-0 link-muted fw-bold small">
                            <i class="bi bi-envelope-at me-1"></i> <span
                                data-i18n="2fa.reset_email_button"><?php echo Lang::get('2fa.reset_email_button'); ?></span>
                        </button>
                    </form>
                </div>
